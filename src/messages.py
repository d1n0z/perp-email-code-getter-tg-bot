...
MESSAGES = {
    "ru": {
        ...
        "start_text": (
            "Отправь email в формате `abc@def.zxc`, и я попробую получить код с этой почты."
        ),
        "help_text": (
            "Что умеет бот:\n"
            "- `/start` — выбрать язык\n"
        ...
        "unknown_text": ("Я жду email в формате `abc@def.zxc` или команду `/start`."),
    },
    "en": {
        ...
        "unknown_text": ("Send an email in the `abc@def.zxc` format or use `/start`."),
    },
}
